...
export default function LoginPage() {
  ...
  const { signIn, signOut, user, isAuthReady, isFetching } = useAppState();
  ...
  // NOT used if we allow for automatic redirect, just above
  return (
    <IntroContainer>
      ...
      {process.env.REACT_APP_SET_AUTH === 'keycloak' && (
        <>
